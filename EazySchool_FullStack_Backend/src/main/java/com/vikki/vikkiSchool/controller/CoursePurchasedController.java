...
import com.vikki.vikkiSchool.model.CoursePurchaseRequest;
...
@Autowired
    ...
    public ResponseEntity<List<AuthRequest>> getEnrolledStudents(@PathVariable Long courseId) {
        List<AuthRequest> students = coursePurchaseService.getEnrolledStudents(courseId);
